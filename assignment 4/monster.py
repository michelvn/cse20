...
def monster_fight(self, monster1, monster2):
    while monster1.hp > 0 and monster2.hp > 0:
        monster1.sort_attack
        monster2.sort_attack
    #each attack decreases HP by damage points
    #continue until one monster's HP <= 0
    #win_fight or lose_fight